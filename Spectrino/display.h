...
// Define the ASCII_Array for writing characters to display
// Refer to notes below for ASCII character definitions
#define ASCII_Array byte ASCII[][5] = \
...
// Retrieves ASCII character from array
void LcdCharacter(char character)
{
  ASCII_Array; // Define ASCII Characters
  LcdWrite(LCD_D, 0x00);
...
// Sets up the display; MUST MAKE A CALL TO THIS BEFORE USING OTHER FUNCTIONS
void LcdInitialise(void)
{
...
// Writes a scrolling message to the display
void Scroll(String message)
{
